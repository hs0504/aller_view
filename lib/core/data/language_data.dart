...
const List<LanguageOption> departureLanguageOptions = [
  ...
  LanguageOption(code: 'de', name: '독일어', nativeName: 'Deutsch', flag: '🇩🇪'),
  LanguageOption(
    code: 'it',
    name: '이탈리아어',
    nativeName: 'Italiano',
  ...
  LanguageOption(code: 'th', name: '태국어', nativeName: 'ไทย', flag: '🇹🇭'),
  LanguageOption(
    code: 'id',
    name: '인도네시아어',
  ...
  LanguageOption(code: 'ar', name: '아랍어', nativeName: 'العربية', flag: '🇸🇦'),
  LanguageOption(code: 'ru', name: '러시아어', nativeName: 'Русский', flag: '🇷🇺'),
];
